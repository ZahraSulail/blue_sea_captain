...
public class TripDetalsFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mDataTextView = view.findViewById( R.id.text_view_date );
        mPositionTextView = view.findViewById( R.id.text_view_position );
        mDestinationTextView = view.findViewById( R.id.text_view_destination );
        mAvailableSeatsTextView = view.findViewById( R.id.text_view_available_seats );
        mBookedSeats = view.findViewById( R.id.text_view_booked_seats );
